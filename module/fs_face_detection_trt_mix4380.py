...
def get_engine(engine_path):
    ...
    print(f"Reading engine from file {os.path.abspath(engine_path)}")
...
class face_detect:
    def __init__(self, engine_path):
        # engine_path = "./model/yolov4_tiny_the2000.trt"###path
        # image_path = "predictions_onnx.jpg"###path
        image_size = (416, 416)  ###path
        # namesfile = 'data/obj.names'###path
        ...
        engine = get_engine(os.path.abspath(engine_path))
    ...
    def detect(self, image_src):
        ...
        # plot_boxes_cv2(image_src, boxes[0], savename='predictions_trt.jpg', class_names="face")
